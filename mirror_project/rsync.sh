...
function Rysnc_Mariadb_For_CentOS7(){
        rsync -avz --exclude-from=$Config_DIR/maradb10.3.list rsync://mirrors.tuna.tsinghua.edu.cn/mariadb/mariadb-10.3.8/yum/centos73-amd64/ $Maridb
...
function List(){
    clear
    echo "+---------------------------------------------------------------------------------------+"
    echo "| Number  Mirrors_Name   Website                      Local_Path           "
    echo "+---------------------------------------------------------------------------------------+"
    ...
    echo "+---------------------------------------------------------------------------------------+"
    echo "| 6       Mariadb10.3.8   $TUNA        $Mariadb"
    echo "+---------------------------------------------------------------------------------------+"
    echo "| 7       REMI           $TUNA       $REMI"
    echo "+---------------------------------------------------------------------------------------+"
    echo "| 8       Mongodb3.6     $TUNA        $MONGODB"
    echo "+---------------------------------------------------------------------------------------+"
}
