...
function _zabbix_6(){
    # base
    _rsync_mirrors $Config_DIR/zabbix-for-centos6.list $rsync_tuna/zabbix/zabbix/3.4/rhel/6/x86_64/ $ZABBIX6
...
function _zabbix_7(){
    # base
    _rsync_mirrors $Config_DIR/zabbix-for-centos7.list $rsync_tuna/zabbix/zabbix/3.4/rhel/7/x86_64/ $ZABBIX7
