...
function _rsync_CentOS7(){
	...
	# centosplus
	#_rsync_mirrors $Config_DIR/centos7.list $rsync_tuna/centos/7/centosplus/x86_64/ $CentOS7/centosplus/x86_64/
...
function _rsync_CentOS6(){
	_rsync_mirrors $Config_DIR/centos6.list $rsync_tuna/centos/6.10/ $CentOS6
